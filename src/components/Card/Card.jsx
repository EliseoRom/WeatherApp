...
export default function Card ({ name, img, onClose, id ,temp ,wind ,humidity ,pressure, nmro}) {
  ...
  if(imgC.current){
    ...
    return (
      ...
      <div className='info'>
         <div className='espac'>
            <p className='textoinfo' style={{ color: `${colortext}`  }}>Viento</p>
            <p className='infoinfo' style={{ color: `${colortext}`  }}>{wind} m/s</p>
         </div>
         <div className='espac'>
            <p className='textoinfo' style={{ color: `${colortext}`  }}>Humedad</p>
            <p className='infoinfo' style={{ color: `${colortext}`  }}>{humidity}%</p>
         </div>
         <div className='espac'>
            <p className='textoinfo' style={{ color: `${colortext}`  }}>Presión</p>
