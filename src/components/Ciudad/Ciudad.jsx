    ...
    if(city.length){
        ...
        <div className='container middle'> 
            ...
            <button className='exit animate__animated animate__fadeIn' onClick={() => history.goBack()} style={{ outline: 'none' }}>
                <p style={{ color: 'Blue'}} className='exit'><i className="fas fa-arrow-left fast"></i> <p className='bklink'>Atras</p></p>
            </button>
             ...
             onClick={() => {
                ...
                <div className='infoP'>
                    <div className='espacP'>
                        <p className='textoinfoP' style={{ color: `${colortext}`  }}>Viento</p>
                        <p className='infoinfoP' style={{ color: `${colortext}`  }}>{city[0].wind} m/s</p>
                    </div>
                    <div className='espacP'>
                        <p className='textoinfoP' style={{ color: `${colortext}`  }}>Humedad</p>
                        <p className='infoinfoP' style={{ color: `${colortext}`  }}>{city[0].humidity}%</p>
                    </div>
                    <div className='espacP'>
                        <p className='textoinfoP' style={{ color: `${colortext}`  }}>Presión</p>
            ...
            onClick={() => {
              ...
              <div className='cityplus'>
                  <div className='infoplus'>
                    <p className='textoinfocity' style={{ color: `${colortext}`  }}>Nombre de la ciudad:</p>
                    <p className='infoinfocity' style={{ color: `${colortext}`  }}>{city[0].name}</p>
                  </div>
                  <div className='infoplus'>
                    <p className='textoinfocity' style={{ color: `${colortext}`  }}>País:</p>
              ...
              <div className='otrosDatos' style={{ color: `${colortext}`  }}>
                  <div className='infoplus'>
                    <p className='textoinfoplus' style={{ color: `${colortext}`  }}><i className="fas fa-cloud-sun"></i> Clima:</p>
                    <p className='infoinfoplus' style={{ color: `${colortext}`  }}>{city[0].description}</p>
                  </div>
                  <div className='infoplus'>
                    <p className='textoinfoplus' style={{ color: `${colortext}`  }}><i className="fas fa-thermometer-half"></i> Sensacion termica:</p>
                    <p className='infoinfoplus' style={{ color: `${colortext}`  }}>{city[0].feelsLike}°</p>
                  </div>
                  <div className='infoplus'>
                    <p className='textoinfoplus' style={{ color: `${colortext}`  }}><i className="far fa-eye"></i> Visibilidad:</p>
                    <p className='infoinfoplus' style={{ color: `${colortext}`  }}>{city[0].visibility / 1000} km</p>
                  </div>
                  <div className='infoplus'>
                    <p className='textoinfoplus' style={{ color: `${colortext}`  }}><i className="fas fa-wind"></i> Viento:</p>
                    <p className='infoinfoplus' style={{ color: `${colortext}`  }}>{city[0].wind} m/s</p>
                  </div>
                  <div className='infoplus'>
                    <p className='textoinfoplus' style={{ color: `${colortext}`  }}><img src={`${humidity}`} style={{ width: '22px' }} className={`filter-${col}`} alt="" /> Humedad:</p>
                    <p className='infoinfoplus' style={{ color: `${colortext}`  }}>{city[0].humidity}%</p>
                  </div>
                  <div className='infoplus'>
                    <p className='textoinfoplus' style={{ color: `${colortext}`  }}><i className="fas fa-tachometer-alt"></i> Presión:</p>
                    <p className='infoinfoplus' style={{ color: `${colortext}`  }}>{city[0].pressure}hPa</p>
                  </div>
                  <div className='infoplus'>
                    <p className='textoinfoplus' style={{ color: `${colortext}`  }}><i className="fas fa-cloud"></i> Nubosidad:</p>
        ...
        return(
          <div className='errorcity'>
              ...
              <p className='errormsg'><span className='span404'>4 4</span>No se enconstraron ciudades</p>
          </div>
        )
    }
